...
export const SelectToken2PopupXrpl = ({ showAddToken }: Props) => {
  ...
  const { close } = usePopup(POPUP_ID.XRPL_ADD_POOL_SELECT_TOKEN2);
  ...
  const { token1, token2, setToken2 } = useXrplPoolAddTokenPairStore();
