...
export const FilterTokenPopupXrpl = ({ showAddToken }: Props) => {
  ...
  const { close } = usePopup(POPUP_ID.XRPL_POOL_FILTER);
  ...
  return (
    <Popup id={POPUP_ID.XRPL_POOL_FILTER} title={t('Select token')}>
      <Wrapper ref={ref}>
        <SearchWrapper>
          <InputSearch
