...
import { NETWORK, NETWORK_NAMES } from '~/types';
    ...
    <Wrapper>
      <TitleWrapper>
        {showToastPopup && (
          <ToastPopup>
            <ToastPopupText>
              Switched to {NETWORK_NAMES[selectedNetwork]} Network’s Liquidity pools
            </ToastPopupText>
          </ToastPopup>
        )}
...
const ToastPopup = tw.div`absolute absolute-center-x top-12 bg-neutral-30 rounded-20 px-20 py-8 `;
