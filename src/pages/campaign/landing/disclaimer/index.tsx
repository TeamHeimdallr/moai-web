...
const Wrapper = tw.div`w-full flex flex-col text-center px-20 py-40 gap-6 font-r-12 text-neutral-70`;
const HyperLink = tw.span`text-neutral-70 underline clickable`;
const Text = tw.div``;
