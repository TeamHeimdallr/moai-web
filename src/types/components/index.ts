...
export enum TOOLTIP_ID {
  ...
  MOAI_FARM_APR = 'MOAI_FARM_APR',

  XRPL_NO_ESTIMATE_VALUE = 'XRPL_NO_ESTIMATE_VALUE',
}
...
export enum POPUP_ID {
  ...
  REWARD_REFERRAL_SHARE = 'REWARD_REFERRAL_SHARE',
  ...
  XRPL_ADD_POOL_SELECT_TOKEN1 = 'XRPL_ADD_POOL_SELECT_TOKEN1',
  XRPL_ADD_POOL_SELECT_TOKEN2 = 'XRPL_ADD_POOL_SELECT_TOKEN2',
  XRPL_ADD_LIQUIDITY_POPUP = 'XRPL_ADD_LIQUIDITY_POPUP',

  XRPL_FEE_VOTING = 'XRPL_FEE_VOTING',
}
