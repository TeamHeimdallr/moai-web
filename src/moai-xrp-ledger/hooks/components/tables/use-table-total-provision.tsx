...
import { useGetLiquidityPoolProvisions } from '~/moai-xrp-ledger/api/api-contract/pool/get-liquidity-pool-provisions';
...
export const useTableTotalProvision = (account: string) => {
  ...
  const { data } = useGetLiquidityPoolProvisions(account);
