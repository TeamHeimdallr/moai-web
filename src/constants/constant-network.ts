...
export const MOAILENS_ADDRESS: Record<string, string> = {
  [NETWORK.THE_ROOT_NETWORK]: IS_MAINNET ? '' : '0xAF6396c1B6603A7f31FC524E9E42c8137aB869eC',
};

export const LENDING_ORACLE_ADDRESS: Record<string, string> = {
  [NETWORK.THE_ROOT_NETWORK]: IS_MAINNET ? '' : '0x13b1e9279A472F88f2e510E429A838003bb3B9F2',
};
