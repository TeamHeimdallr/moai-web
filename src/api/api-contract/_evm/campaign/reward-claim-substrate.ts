...
import { CAMPAIGN_REWARD_ADDRESS, IS_MAINNET } from '~/constants';
...
import { useUserCampaignInfo } from './user-campaign-info.ts.ts';
  ...
  const estimateFee = async () => {
    ...
    try {
      ...
      const evmCall = api.tx.evm.call(
        walletAddress,
        CAMPAIGN_REWARD_ADDRESS[NETWORK.THE_ROOT_NETWORK] as Address,
        encodedData,
        0,
        evmGas,
